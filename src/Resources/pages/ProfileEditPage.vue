...
<template>
  <div class="space-y-6 col-span-2">
    ...
    <div class="grid gap-2">
      ...
      />
      <p class="text-sm text-muted-foreground">Your unique username. This is the name other users can find you with.</p>
    ...
    <div class="grid gap-2">
      ...
      />
      <p class="text-sm text-muted-foreground">Your email address. This is used for account recovery and notifications.</p>
    ...
    <div class="grid gap-2">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          />
          <p class="text-sm text-muted-foreground">Upload a new profile picture. Recommended size is 256x256 pixels.</p>
    ...
    <div class="grid gap-2">
      ...
      />
      <p v-if="passwordErrors.current_password" id="current-password-error" class="text-red-500 text-sm" role="alert" aria-live="polite">
    ...
    <div class="grid gap-2">
      ...
      />
      <p v-if="passwordErrors.new_password" id="new-password-error" class="text-red-500 text-sm" role="alert" aria-live="polite">
    ...
    <div class="grid gap-2">
      ...
      />
      <p v-if="passwordErrors.new_password_confirmation" id="new-password-confirmation-error" class="text-red-500 text-sm" role="alert" aria-live="polite">
