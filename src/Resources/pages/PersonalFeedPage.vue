  ...
  <div class="space-y-6">
    ...
    <div v-if="error && !isLoading" class="flex flex-col items-center justify-center py-12">
      <div class="text-center">
        ...
        <div class="flex gap-3 justify-center">
          <Button variant="outline" @click="fetchPersonalFeed">
            Try Again
          </Button>
          <Button v-if="!userStore.getIsAuthenticated" as-child>
            <RouterLink to="/login">
    ...
    <div v-else class="flex flex-col items-center justify-center py-16">
      <div class="text-center space-y-4">
        <div class="text-6xl mb-4">👥</div>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Your feed is empty</h2>
        <p class="text-muted-foreground max-w-md">
          Follow some users to see their posts in your personal feed. Or explore all posts to discover interesting content!
        </p>
