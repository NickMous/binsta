...
return [
    Route::group('/api', [
        ...
        Route::group('/posts', [
            ...
            Route::get('/{post:\d+}/fork-status', className: PostController::class, methodName: 'forkStatus'),
            Route::post('/{post:\d+}/fork', className: PostController::class, methodName: 'fork'),
            Route::get('/{post:\d+}/forks', className: PostController::class, methodName: 'forks'),
